<template>
    <div class="flex justify-between items-center odd:bg-gray-600 px-2 py-1">
        ...
        <button @click="deleteItem" class="bg-indigo-400 px-3 py-1 rounded-md active:bg-indigo-600">Sil</button>
    </div>
</template>
<script>
export default {
